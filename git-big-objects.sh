...
#
# usage:
#      $ git-big-objects.sh 100		# find and list biggest 100 objects
#
...
# set the internal field separator to line break, to simplify iterating over the verify-pack output
IFS=$'\n';
...
echo "All sizes are in kB's. The 'packed' column is the size of the object, compressed, inside the pack file."

output="size,packed,objectId,path"
for y in $objects
do
    ...
    # find the objects path in the repository tree
