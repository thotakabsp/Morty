...
int main(int argc, char **argv)
{
	...
	show_image("/home/root/Scripts/1.jpg");
	sleep(2);
	show_image("/home/root/Scripts/2.jpg");
	sleep(2);
	show_image("/home/root/Scripts/3.jpg");
	sleep(2);
	show_image("/home/root/Scripts/4.jpg");
	sleep(2);
	show_image("/home/root/Scripts/5.jpg");
	sleep(2);
	setcolor(5);
	resetfb();
#if 0
	show_status(&fb_info, 0);
	fd = open("/sys/class/gpio/gpio146/value", O_RDONLY);
	while(count < 100){
		...
		if(value == '0')
		{ 
			show_status(&fb_info, 2);
			// Current GPIO status low
		}
		else
		{
			show_status(&fb_info, 1);
