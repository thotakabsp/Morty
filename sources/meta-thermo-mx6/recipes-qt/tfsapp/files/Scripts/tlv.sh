...
i2cset -y 1 0x18 0x34 0x14      # <<<TFS>>> Modified, We are using  IN1L instead
i2cset -y 1 0x18 0x36 0x40
i2cset -y 1 0x18 0x37 0x14      # <<<TFS>>> Modified, We are using IN1R instead
i2cset -y 1 0x18 0x39 0x40
