...
do_configure_prepend() {
    ...
    MAKEFLAGS="${PARALLEL_MAKE}" ${S}/configure -commercial -confirm-license ${PACKAGECONFIG_CONFARGS} || die "Configuring qt failed. PACKAGECONFIG_CONFARGS was ${PACKAGECONFIG_CONFARGS}"
}
